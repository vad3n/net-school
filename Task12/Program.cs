...
//ICatalogSerializer serializer = new JsonCatalogSerializer();
//serializer.Save(catalog, "catalog.json");
//Catalog jsonCatalog = serializer.Restore("catalog.json");
//serializer = new XmlCatalogSerializer();
//serializer.Save(catalog, "catalog.xml");
//Catalog xmlCatalog = serializer.Restore("catalog.xml");